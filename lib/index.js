...
function findOrganizationById(id) {
  ...
  const organizationById = organizations.find((organization) => organization.id === id)  
  return  Promise.resolve (organizationById)
...
return  findUserById(id)
        .then( (user) => { 
         ...
         findOrganizationById(user.organizationId)
         .then((org) => {
           return user + org
         })
         }
